...
SOURCES = \
	__init__.py \
	new_ccu_db.py new_ccu_db_dialog.py

PLUGINNAME = new_ccu_db

PY_FILES = \
	__init__.py \
	new_ccu_db.py new_ccu_db_dialog.py

UI_FILES = new_ccu_db_dialog_base.ui
...
QGISDIR=C:\Users\mique\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
